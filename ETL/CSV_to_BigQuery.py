...
PATH = r'C:\Users\62895\Documents\DSH\DSH'
file = glob2.glob(PATH + "/*.csv")

class RowTransformer(beam.DoFn):
    def __init__(self, delimiter):
        self.delimiter = delimiter

def extract_transform(self, row):
    csv_data = csv.reader(row.splitlines(), quotechar='"', delimiter=',', quoting=csv.QUOTE_ALL)
