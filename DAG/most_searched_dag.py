...
PY_FILE = (
    f'gs://{COMPOSER_BUCKET_NAME}/dataflow-functions/BQ_to_BQ.py' if Variable.get('ENVIRONMENT') == 'production'
    else f"{os.path.dirname(configuration.conf.get('core', 'dags_folder'))}/dataflow-functions/BQ_to_BQ.py")
